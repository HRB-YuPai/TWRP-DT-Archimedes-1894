...
SHRP_EXTERNAL_ADDON_2_NAME := "[MIUI] Disable Replace SHRP"
SHRP_EXTERNAL_ADDON_2_INFO := "Flash in MIUI To Stop MIUI Recovery From Replacing"
SHRP_EXTERNAL_ADDON_2_FILENAME := "disable-replace-shrp.zip"
SHRP_EXTERNAL_ADDON_2_BTN_TEXT := "Flash"
SHRP_EXTERNAL_ADDON_2_SUCCESSFUL_TEXT := "Installed"
SHRP_INC_IN_REC_EXTERNAL_ADDON_2 := true
SHRP_EXTERNAL_ADDON_3_NAME := "System RW Support"
SHRP_EXTERNAL_ADDON_3_INFO := "Make System to read and writeable"
SHRP_EXTERNAL_ADDON_3_FILENAME := "systemrw.zip"
...
SHRP_EXTERNAL_ADDON_4_NAME := "F2FS Patcher"
SHRP_EXTERNAL_ADDON_4_INFO := "Patch Vendor For Mount F2fs"
SHRP_EXTERNAL_ADDON_4_FILENAME := "F2fs-patcher.zip"
SHRP_EXTERNAL_ADDON_4_BTN_TEXT := "Flash"
SHRP_EXTERNAL_ADDON_4_SUCCESSFUL_TEXT := "Now You Can use DATA and CACHE as f2fs"
SHRP_INC_IN_REC_EXTERNAL_ADDON_4 := true
SHRP_EXTERNAL_ADDON_5_NAME := "Imei Backup"
SHRP_EXTERNAL_ADDON_5_INFO := "Takes Imei backup"
SHRP_EXTERNAL_ADDON_5_FILENAME := "Imei-Backup.zip"
...
SHRP_EXTERNAL_ADDON_6_NAME := "vbmetapatcher"
SHRP_EXTERNAL_ADDON_6_INFO := "Patch vbmeta for fixing bootloop"
SHRP_EXTERNAL_ADDON_6_FILENAME := "vbmetapatch.zip"
...
SHRP_EXTERNAL_ADDON_7_NAME := "Aroma file manager"
SHRP_EXTERNAL_ADDON_7_INFO := "Flash for using it"
SHRP_EXTERNAL_ADDON_7_FILENAME := "aromafm-2.00b7.zip"
...
SHRP_EXTERNAL_ADDON_8_NAME := "Product and vendor backuper"
SHRP_EXTERNAL_ADDON_8_INFO := "Creat product.img and vendor.img in internal storage"
SHRP_EXTERNAL_ADDON_8_FILENAME := "pv-backuper.zip"
...
SHRP_EXTERNAL_ADDON_9_NAME := "System vendor and product resizer"
SHRP_EXTERNAL_ADDON_9_INFO := "Must flash _Product and vendor backuper_ first because you lose them and must be restore for booting your device. "
SHRP_EXTERNAL_ADDON_9_FILENAME := "spv-resizer.zip"
...
SHRP_EXTERNAL_ADDON_10_NAME := "[A9] System and vendor resizer"
SHRP_EXTERNAL_ADDON_10_INFO := "Flash for resize may not work with a12 for a12 use above zips"
SHRP_EXTERNAL_ADDON_10_FILENAME := "sv_resizer.zip"
